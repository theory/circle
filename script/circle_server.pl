...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CIRCLE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CIRCLE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
circle_server.pl - Catalyst Testserver

=head1 SYNOPSIS

circle_server.pl [options]
